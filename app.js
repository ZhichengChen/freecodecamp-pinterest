...
app.get('/auth/twitter/callback', 
  passport.authenticate('twitter', { failureRedirect: '/login' }),routes.index);
...
app.get('/my', login, routes.my);
app.get('/user/:username', routes.user);
app.get('/add', login, routes.add);
app.post('/add', login, routes.create);
app.get('/delete/:pin', login, routes.delete);
